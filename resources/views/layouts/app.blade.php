...
<body>
    ...
    <footer class="text-light py-3 d-flex justify-content-end">
        <div class="alinhar-logo" style="padding:0px;padding-right:5%">
            <span>Desenvolvido por: </span><a href="https://www.handson-ti.com.br/?utm_campaign=footer-website&utm_source=fleischmannprofissional" target="_blank"><img class="logo-footer" src="<?= asset('/img/logo-hands.png'); ?>"></a>
        </div>
    </footer>
